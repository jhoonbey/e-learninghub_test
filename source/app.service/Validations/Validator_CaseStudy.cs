...
namespace app.database.Validations
{
    ...
    {
        public static void CaseStudyCreateValidation(CaseStudy model)
        {
            //model
            ...
            //CategoryId
            if (model.CategoryId < 1) throw new Exception("Select Category");
        }
        public static void CaseStudyEditValidation(CaseStudy model)
        {
            //model
            if (model == null) throw new Exception("Fill form correct");
        ...
        public static void CaseStudyUpdateImageValidation(int id, HttpPostedFileBase postedFile, int minHeight, int maxHeight, int minWidth, int maxWidth, bool watchSizes = false)
        {
            //model
            if (postedFile == null) throw new Exception("Select photo, please");
            if (id < 1) throw new Exception("Please select CaseStudy");
