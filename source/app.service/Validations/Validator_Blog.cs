...
namespace app.database.Validations
{
    ...
    {
        public static void BlogCreateValidation(Blog model)
        {
            //model
        ...
        public static void BlogEditValidation(Blog model)
        {
            //model
            if (model == null) throw new Exception("Fill form correct");
        ...
        public static void BlogUpdateImageValidation(int id, HttpPostedFileBase postedFile, int minHeight, int maxHeight, int minWidth, int maxWidth, bool watchSizes = false)
        {
            //model
            if (postedFile == null) throw new Exception("Select photo, please");
            if (id < 1) throw new Exception("Please select Blog");
