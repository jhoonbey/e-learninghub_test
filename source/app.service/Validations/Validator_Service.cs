...
namespace app.database.Validations
{
    ...
    //{
    //    public static void ServiceCreateValidation(Service model)
    //    {
    //        //model
    ...
    //    }
    //    public static void ServiceEditValidation(Service model)
    //    {
    //        //model
    //        if (model == null) throw new Exception("Fill form correct");
    ...
    //    public static void ServiceUpdateImageValidation(int id, HttpPostedFileBase postedFile, int minHeight, int maxHeight, int minWidth, int maxWidth, bool watchSizes = false)
    //    {
    //        //model
    //        if (postedFile == null) throw new Exception("Select photo, please");
    //        if (id < 1) throw new Exception("Please select Service");
